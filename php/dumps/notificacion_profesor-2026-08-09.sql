...
CREATE SEQUENCE "public".alumnos_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
...
(1,	4132,	'ALEXIS ADRIAN',	'ESPERATTI',	'40788695',	'aesperatti.fmed@gmail.com',	3),
(3,	11111,	'RODRIGO',	'MÉNDEZ',	'36100200',	'mendeez.r@gmail.com',	3),
(4,	2222,	'DAVID',	'CORIA',	'43100200',	'davidcoria004@gmail.com',	3);

DROP TABLE IF EXISTS "aulas";
DROP SEQUENCE IF EXISTS "public".aula_id_seq;
CREATE SEQUENCE "public".aula_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
...
CREATE SEQUENCE "public".carrera_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
...
CREATE SEQUENCE "public".estados_inscripcion_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
...
CREATE SEQUENCE "public".inscripciones_id_inscripcion_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
...
CREATE UNIQUE INDEX inscripciones_alumno_mesa_unique ON public.inscripciones USING btree (id_alumno, id_mesa) WHERE ((id_alumno IS NOT NULL) AND (id_mesa IS NOT NULL));

INSERT INTO "inscripciones" ("id_inscripcion", "id_alumno", "id_materia", "fecha_inscripcion", "id_estado", "id_condicion", "motivo", "id_mesa") VALUES
(15,	66,	30,	'2026-08-13',	1,	1,	NULL,	15),
(30,	4,	30,	'2026-08-13',	3,	1,	'NO CUMPLE CON LOS REQUISITOS ACADEMICOS',	15),
(16,	81,	28,	'2026-08-04',	1,	1,	NULL,	13),
(17,	76,	28,	'2026-08-04',	2,	2,	NULL,	13),
(18,	74,	28,	'2026-08-04',	2,	1,	NULL,	13),
(19,	68,	28,	'2026-08-04',	2,	1,	NULL,	13),
(23,	1,	28,	'2026-08-04',	2,	1,	NULL,	13),
(11,	73,	29,	'2026-08-11',	1,	2,	NULL,	14),
(26,	3,	29,	'2026-08-11',	2,	1,	NULL,	14),
(29,	4,	29,	'2026-08-11',	2,	1,	NULL,	14),
(3,	73,	6,	'2026-06-03',	1,	1,	NULL,	17),
(13,	79,	6,	'2026-08-06',	2,	1,	NULL,	17),
(24,	1,	6,	'2026-08-06',	3,	1,	'NO CUMPLE CON LOS REQUISITOS ACADEMICOS',	17),
(25,	3,	6,	'2026-08-06',	2,	1,	NULL,	17),
(28,	4,	6,	'2026-08-06',	2,	1,	NULL,	17),
(14,	67,	31,	'2026-08-19',	3,	1,	NULL,	16),
(27,	3,	31,	'2026-08-19',	3,	2,	'NO CUMPLE CON LOS REQUISITOS ACADEMICOS',	16),
(31,	4,	31,	'2026-08-19',	3,	2,	'FALTAN PAPELES',	16),
(21,	63,	2,	'2026-07-03',	1,	1,	NULL,	2),
(12,	80,	1,	'2026-06-26',	2,	2,	NULL,	1),
(22,	70,	1,	'2026-06-26',	3,	2,	NULL,	1),
(2,	71,	32,	'2026-06-30',	3,	1,	NULL,	12),
(5,	71,	27,	'2026-06-30',	3,	1,	NULL,	9),
(6,	71,	27,	'2026-07-05',	1,	1,	NULL,	7),
(7,	77,	32,	'2026-06-27',	1,	1,	NULL,	11),
(9,	71,	32,	'2026-06-27',	2,	2,	NULL,	11),
(20,	69,	32,	'2026-06-27',	2,	2,	NULL,	11);

DROP TABLE IF EXISTS "marcador_envio_de_mail";
DROP SEQUENCE IF EXISTS "public".marcador_envio_de_mail_id_marcador_envio_de_mail_seq;
CREATE SEQUENCE "public".marcador_envio_de_mail_id_marcador_envio_de_mail_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;

CREATE TABLE "public"."marcador_envio_de_mail" (
    "id_marcador_envio_de_mail" integer DEFAULT nextval('marcador_envio_de_mail_id_marcador_envio_de_mail_seq') NOT NULL,
    "id_alumno" integer NOT NULL,
    "email_destino" text NOT NULL,
    "asunto" text NOT NULL,
    "cantidad_inscripciones" integer DEFAULT '0' NOT NULL,
    "resultado" character varying(20) DEFAULT 'OK' NOT NULL,
    "detalle" text,
    "enviado_en" timestamp DEFAULT CURRENT_TIMESTAMP NOT NULL,
    CONSTRAINT "marcador_envio_de_mail_pkey" PRIMARY KEY ("id_marcador_envio_de_mail")
)
WITH (oids = false);

CREATE INDEX idx_marcador_envio_de_mail_alumno ON public.marcador_envio_de_mail USING btree (id_alumno);

CREATE INDEX idx_marcador_envio_de_mail_enviado_en ON public.marcador_envio_de_mail USING btree (enviado_en);

INSERT INTO "marcador_envio_de_mail" ("id_marcador_envio_de_mail", "id_alumno", "email_destino", "asunto", "cantidad_inscripciones", "resultado", "detalle", "enviado_en") VALUES
(5,	3,	'mendeez.r@gmail.com',	'Estado de tus Inscripciones a las Mesas de Examen',	3,	'OK',	NULL,	'2026-06-29 16:25:44.948971'),
(6,	4,	'davidcoria004@gmail.com',	'Estado de tus Inscripciones a las Mesas de Examen',	4,	'OK',	NULL,	'2026-06-29 16:28:18.726805'),
(10,	1,	'aesperatti.fmed@gmail.com',	'Estado de tus Inscripciones a las Mesas de Examen',	2,	'OK',	NULL,	'2026-07-06 23:54:33.851712');
...
(28,	'BD1',	'BASES DE DATOS I',	1,	4,	2,	'2026-08-04'),
...
CREATE SEQUENCE "public".profesores_id_seq INCREMENT 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1;
...
ALTER TABLE ONLY "public"."inscripciones" ADD CONSTRAINT "inscripciones_id_mesa_fkey" FOREIGN KEY (id_mesa) REFERENCES mesas_examen(id) ON UPDATE CASCADE ON DELETE RESTRICT;

ALTER TABLE ONLY "public"."marcador_envio_de_mail" ADD CONSTRAINT "marcador_envio_de_mail_id_alumno_fkey" FOREIGN KEY (id_alumno) REFERENCES alumnos(id) ON UPDATE CASCADE ON DELETE CASCADE;
